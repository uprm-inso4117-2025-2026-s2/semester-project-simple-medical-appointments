...
|===
|Req ID |Description |Linked Epics/Features
|[[REQ-AUTH-F-01]]REQ-AUTH-F-01 |Authenticate users, create accounts, and enforce role-based access (patient, doctor, admin). Provide clear failure reasons and lockout on repeated failures. |E1 -> F1.1, F1.4
|[[REQ-PROF-F-01]]REQ-PROF-F-01 |Persist patient and doctor profile data (name, contact, specialty/clinic, accessibility prefs). Validate required fields, allow users to update their own profiles, and audit changes. |E1 -> F1.2, F1.3
|[[REQ-AVAIL-F-01]]REQ-AVAIL-F-01 |Allow providers to declare weekly availability and ad-hoc slots; prevent overlapping slots and surface conflicts to the user. |E2 -> F2.1, F2.2, F2.3
|[[REQ-BOOK-F-01]]REQ-BOOK-F-01 |Let patients book available slots, reserve the slot atomically, and prevent double booking. |E3 -> F3.2, F3.3, F3.4
|[[REQ-BOOK-F-02]]REQ-BOOK-F-02 |Allow patients to cancel upcoming appointments and immediately release the slot for reuse. |E3 -> F3.3
|[[REQ-NOTIF-F-01]]REQ-NOTIF-F-01 |Send confirmation notifications after successful booking, including appointment details. |E4 -> F4.1
|[[REQ-NOTIF-F-02]]REQ-NOTIF-F-02 |Send reminder notifications before the appointment based on user preferences. |E4 -> F4.2, F4.3
|[[REQ-ADMIN-F-01]]REQ-ADMIN-F-01 |Provide admins with read-only oversight dashboards (appointments, users, activity) with filtering/export; enforce least-privilege access. |E5 -> F5.1, F5.2
|===

&#160;

[discrete]
===== *_Epic E1: Trusted Care Identity & Profiles_*

*Goal:* Ensure patients and doctors are recognized securely so their appointments, history, and permissions travel with them.

*Problem/value:* Users need trusted identities and accurate profiles to receive the right care, see their history, and communicate with providers.
...
_"As a patient or doctor, I want the system to recognize me securely so that my appointments, notes, and permissions are tied to me across visits."_
...
[discrete]
===== _US.PROF.01: Maintain my profile | ReqRef: <<REQ-PROF-F-01>>_
...
|[[US-AUTH-01]]US-AUTH-01 |F1.1, F1.4 |<<REQ-AUTH-F-01>> |Authentication and role logic.
|[[US-PROF-01]]US-PROF-01 |F1.2, F1.3 |<<REQ-PROF-F-01>> |Profile persistence and validation.
|===
...
[discrete]
===== _US.AVAIL.01: Set my availability | ReqRef: <<REQ-AVAIL-F-01>>_
...
|===
|Story ID |Feature |ReqRef |Notes
|[[US-AVAIL-01]]US-AVAIL-01 |F2.1, F2.2, F2.3 |<<REQ-AVAIL-F-01>> |Calendar conflict rules.
|===
...
[discrete]
===== _US.BOOK.01: Book an appointment | ReqRef: <<REQ-BOOK-F-01>>_
...
[discrete]
===== _US.BOOK.02: Cancel an appointment | ReqRef: <<REQ-BOOK-F-02>>_
...
|===
|Story ID |Feature |ReqRef |Notes
|[[US-BOOK-01]]US-BOOK-01 |F3.2, F3.3, F3.4 |<<REQ-BOOK-F-01>> |Booking transaction and conflict handling.
|[[US-BOOK-02]]US-BOOK-02 |F3.3 |<<REQ-BOOK-F-02>> |Cancellation logic.
|===
...
[discrete]
===== _US.NOTIF.01: Receive appointment confirmation | ReqRef: <<REQ-NOTIF-F-01>>_
...
[discrete]
===== _US.NOTIF.02: Receive appointment reminder | ReqRef: <<REQ-NOTIF-F-02>>_
...
|===
|Story ID |Feature |ReqRef |Notes
|[[US-NOTIF-01]]US-NOTIF-01 |F4.1 |<<REQ-NOTIF-F-01>> |Confirmation trigger.
|[[US-NOTIF-02]]US-NOTIF-02 |F4.2, F4.3 |<<REQ-NOTIF-F-02>> |Reminder scheduler and preferences.
|===
...
[discrete]
===== _US.ADMIN.01: Monitor appointments | ReqRef: <<REQ-ADMIN-F-01>>_
...
|===
|Story ID |Feature |ReqRef |Notes
|[[US-ADMIN-01]]US-ADMIN-01 |F5.1, F5.2 |<<REQ-ADMIN-F-01>> |Admin read access and filtering.
|===