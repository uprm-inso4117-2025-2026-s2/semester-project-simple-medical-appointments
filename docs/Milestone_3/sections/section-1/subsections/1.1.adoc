...
The project for Milestone 1 is organized into 5 functional teams: Roles and Permissions, Clinical Experience, Patient Experience, Scheduling, and Documentation; plus 2 Managers.  
...
The structure reflects the need to address role and permission rules across patients, doctors, and clinic staff, clinical workflow representation, patient interaction, appointment logistics,
...
The Roles and Permissions Team is responsible for defining the domain roles involved in the appointment process and the permissions attached to each one.
Their responsibility is to describe how patients, doctors, and clinic staff participate in the domain, what information each role can manage, and which actions each role is allowed to perform.

This team focuses on role boundaries, access responsibilities, and permission rules that keep patient care, provider activities, and clinic operations clearly coordinated within the domain.
