...
Overall, the current appointment scheduling environment in Puerto Rico is
characterized by high demand for care, reduced provider availability, fragmented
scheduling practices, and reliance on manual coordination processes. These
conditions contribute to delayed access to healthcare, increased administrative
burden for clinics, and inefficient allocation of available appointment slots.